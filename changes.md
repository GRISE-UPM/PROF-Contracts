Con respecto al apartado "g" ha colocado un @Ensure para getFee >= 0 tanto para master como para grado, pero esto puede probar ya que no se puede dar una situación posible en la que el valor del importe una asignatura pueda ser negativo: 
